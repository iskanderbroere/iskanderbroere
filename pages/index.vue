<template>
  <div class="container">
    <nav>
      ...
      <div class="icons">
        <!-- <a href="https://github.com/iskanderbroere/" target="_blank">
          <svg 
    ...
    <main>
      <section>
        ...
        <dl>
          ...
          <dt>use</dt>
          <dd>JS - HTML - CSS - GraphQL - Markdown - MongoDB - PostgreSQL - Vue - React - Express - Mongoose - Sequelize - PostCSS - SCSS - Apollo GraphQL - Bootstrap - Webpack - Yarn - NPM - ESLint - Stylelint - Prettier - VSCode - Hyper - Netlify - GitHub</dd>
          <dt>like</dt>
        ...
        <address>
          <a class="email" href="mailto:iskanderbroere@gmail.com">iskanderbroere@gmail.com</a>
        </address>
        <div class="icons-sm">
          <!-- <a href="https://github.com/iskanderbroere/" target="_blank">
            <svg 
